				...
				<div className="flex items-start gap-3">
					<div className="flex-1">
						...
						<div className="mt-2 flex items-center justify-between">
							<span className="text-base font-semibold text-[color:var(--color-brand-red)]">${offer.price.toFixed(2)}</span>
							<button
								onClick={() => dispatch(addItem({ item: offer.item, qty: 1 }))}
								className="px-3 py-1 rounded bg-[color:var(--color-brand-red)] text-white"
							>
								Add
							</button>
						</div>
